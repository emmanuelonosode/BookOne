  ...
  const confettiPieces = React.useMemo(
    () =>
      [...Array(25)].map((_, i) => ({
        ...
        duration: Math.random() * 2 + 1.5, // Reduced duration
        delay: Math.random() * 0.3, // Reduced delay
        xOffset: Math.random() * 150 - 75, // Reduced movement
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="text-center space-y-6 pt-8">
                      <button
                        ...
                        aria-label="Get my free strategy session - Submit project details for consultation"
                        className={`
