  ...
  switch (block.type) {
    case "header": {
      ...
      const headerStyles = {
        ...
        2: "text-3xl font-semibold text-dark mb-3",
        3: "text-2xl font-semibold text-neutral mb-2",
        4: "text-xl font-medium text-muted mb-2",
        5: "text-lg font-medium text-gray-700 mb-1",
        6: "text-base font-normal text-gray-600 mb-1",
      };

      return (
        <Tag
          key={block.id}
          className={headerStyles[block.data.level] || "text-base"}
        >
          {block.data.text}
        </Tag>
      );
