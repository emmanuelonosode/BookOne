...
export default function AboutSection({
  storyHeadline = "How BookOne Began",
  storyParagraph = "At BookOne, we believe every business deserves a strong online presence. Our journey started with a simple mission — to help small and growing businesses thrive through exceptional websites, smart automation, and digital strategies. What began as a passion for building beautiful, functional sites has grown into a full-service agency focused on innovation and results. From user-friendly designs to powerful backend systems, we create custom solutions that fuel real growth. We're not just developers — we're partners in your success.",
  ...
  storyImageAlt = "A BookOne team member collaborating on a project",

  statsHeadline = "Our Impact by the Numbers",
  statsParagraph = "Since our start, BookOne has helped dozens of businesses elevate their digital presence. With a focus on quality, strategy, and measurable results, we continue to drive growth for our clients in Nigeria and beyond.",
  statsData = [
    { value: "30+", description: "Projects completed" },
    { value: "120%", description: "Year-on-year growth" },
    { value: "$75K+", description: "Value delivered" },
    { value: "20+", description: "Satisfied clients" },
  ],
