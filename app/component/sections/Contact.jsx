        ...
        <div className="rounded-3xl bg-[#15803D] px-8 py-14 sm:px-16 sm:py-20 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Magnetic strength={20}>
              <Link
                href="/get-started"
                className="inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm sm:text-base font-semibold text-[#15803D] hover:bg-[#F0FDF4] transition-colors"
              >
                Get a free quote
