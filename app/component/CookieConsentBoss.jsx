          ...
          <div className="max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 py-5 flex items-center justify-between gap-6 flex-wrap">
            ...
            <div className="flex items-center gap-5 shrink-0">
              <button
                ...
                className="text-[10px] font-mono uppercase tracking-[0.15em] text-[#6F6A62] hover:text-[#1C1917] transition-colors duration-200"
              >
                Decline
              </button>
              <button
                onClick={handleAccept}
                className="text-[10px] font-mono uppercase tracking-[0.15em] border border-[#15803D]/40 text-[#15803D] hover:bg-[#15803D] hover:text-[#F4F1EA] px-4 py-2 transition-all duration-200"
              >
                Accept All
              </button>
            </div>
